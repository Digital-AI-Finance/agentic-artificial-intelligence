...
\begin{itemize}
\item \textbf{Remember}: Define CoT (Chain-of-Thought), ToT (Tree-of-Thoughts), Self-Consistency
...
\begin{center}
\includegraphics[width=0.65\textwidth]{01_cot_vs_tot/cot_vs_tot.pdf}
\end{center}
...
\begin{itemize}
\item Sample multiple reasoning paths at temperature (randomness) $> 0$
...
\begin{itemize}
\item No few-shot (example-based) prompts needed
...
\begin{center}
\includegraphics[width=0.60\textwidth]{02_context_window/context_window.pdf}
\end{center}
...
\item \textbf{RAG} (Retrieval-Augmented): Fetch relevant context on demand
...
% ==================== SLIDE 11: Prompting Comparison Chart ====================
\begin{frame}[t]{Prompting Strategies on GSM8K}
\begin{center}
\includegraphics[width=0.60\textwidth]{03_prompting_comparison/prompting_comparison.pdf}
\end{center}
\bottomnote{Self-consistency achieves 74.4\% accuracy vs 17.1\% zero-shot (GSM8K benchmark).}
\end{frame}

% ==================== SLIDE 12: Cost vs Accuracy ====================
\begin{frame}[t]{Cost vs Accuracy Tradeoff}
\begin{center}
\includegraphics[width=0.60\textwidth]{04_token_efficiency/token_efficiency.pdf}
\end{center}
\bottomnote{Better accuracy requires more tokens -- choose based on task criticality.}
\end{frame}

% ==================== SLIDE 13: Prompting Strategies ====================
