...
for values, label, color in [
    (gpt4_agent, "GPT-4 Agent", MLPURPLE),
...
plt.tight_layout()
plt.savefig(Path(__file__).parent / "evaluation_dimensions.pdf", dpi=300, bbox_inches="tight", facecolor="white")
plt.close()
print(f"Chart saved to {Path(__file__).parent / 'evaluation_dimensions.pdf'}")
