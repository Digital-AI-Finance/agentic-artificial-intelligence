...
ax.text(
    5, 5.7, "Agent Benchmark Landscape", fontsize=24, fontweight="bold", ha="center", color=MLPURPLE
)
...
plt.tight_layout()
plt.savefig(Path(__file__).parent / "benchmark_landscape.pdf", dpi=300, bbox_inches="tight", facecolor="white")
plt.close()
print(f"Chart saved to {Path(__file__).parent / 'benchmark_landscape.pdf'}")
