...
bars1 = ax.bar(x - width, webshop, width, label='WebShop', color=MLPURPLE, edgecolor='white', linewidth=1.5)
bars2 = ax.bar(x, alfworld, width, label='ALFWorld', color=MLBLUE, edgecolor='white', linewidth=1.5)
bars3 = ax.bar(x + width, hotpotqa, width, label='HotpotQA', color=MLORANGE, edgecolor='white', linewidth=1.5)
...
ax.annotate('', xy=(4.3, 75), xytext=(0, 42),
            arrowprops=dict(arrowstyle='->', color=MLGREEN, lw=2, ls='--'))
ax.text(2.5, 35, 'Improvement with planning', fontsize=14, color=MLGREEN,
