...
| Week | Papers | Focus |
|------|--------|-------|
| 1 | ReAct, LLM Agent Surveys | Foundation |
| 2 | CoT, ToT, Self-Consistency | Reasoning |
| 3 | Toolformer, API-Bank, Gorilla | Tool Use |
| 4 | Reflexion, LATS, Plan-and-Solve | Planning |
| 5 | AutoGen, MetaGPT, ChatDev | Multi-Agent |
| 6 | LangGraph, CrewAI, TaskWeaver | Frameworks |
| 7 | Self-RAG, CRAG, RAPTOR | Advanced RAG |
| 8 | GraphRAG, HippoRAG, GoT | Knowledge |
| 9 | FActScore, CoVe, Self-Refine | Hallucination |
| 10 | AgentBench, WebArena, GAIA | Evaluation |
| 11 | Devin, AlphaCodium, FinAgent | Applications |
| 12 | Voyager, Generative Agents | Frontiers |
