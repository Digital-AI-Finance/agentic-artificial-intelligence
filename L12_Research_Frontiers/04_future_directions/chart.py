...
ax.text(5, 5.7, 'Future Research Directions', fontsize=24,
        fontweight='bold', ha='center', color=MLPURPLE)

# Near-term (1-2 years)
near_box = FancyBboxPatch((0.5, 3.2), 2.8, 2.0,
...
# Mid-term (2-5 years)
mid_box = FancyBboxPatch((3.6, 3.2), 2.8, 2.0,
...
# Long-term (5+ years)
long_box = FancyBboxPatch((6.7, 3.2), 2.8, 2.0,
...
# Arrows
ax.annotate('', xy=(3.4, 4.2), xytext=(3.0, 4.2),
            arrowprops=dict(arrowstyle='->', color=MLGRAY, lw=2))
ax.annotate('', xy=(6.5, 4.2), xytext=(6.1, 4.2),
            arrowprops=dict(arrowstyle='->', color=MLGRAY, lw=2))

# Cross-cutting themes
ax.text(5, 2.5, 'Cross-cutting: Safety | Alignment | Interpretability | Evaluation',
        fontsize=12, ha='center', color=MLGREEN, fontweight='bold')

# Call to action
ax.text(5, 1.5, 'Key insight: Progress requires interdisciplinary collaboration',
        fontsize=11, ha='center', color=MLPURPLE, style='italic')
