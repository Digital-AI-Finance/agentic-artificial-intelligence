...
# Safety challenges
challenges = ['Prompt\nInjection', 'Tool\nMisuse', 'Goal\nHijacking', 'Deception', 'Unintended\nActions', 'Cascading\nFailures']
...
bars1 = ax.bar(x - width/2, severity, width, label='Severity', color=MLRED, edgecolor='white', linewidth=1.5)
bars2 = ax.bar(x + width/2, mitigation_difficulty, width, label='Mitigation Difficulty', color=MLORANGE, edgecolor='white', linewidth=1.5)
