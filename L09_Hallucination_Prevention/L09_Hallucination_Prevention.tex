...
\begin{center}
\includegraphics[width=0.60\textwidth]{01_hallucination_types/chart.pdf}
\end{center}
\bottomnote{Factual hallucinations are highest risk; instruction drift is most common.}
\end{frame}

\begin{frame}[t]{Chain-of-Verification Pipeline}
\begin{center}
\includegraphics[width=0.65\textwidth]{02_verification_pipeline/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{03_factscore/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{04_mitigation_strategies/chart.pdf}
\end{center}
...
\item \textbf{Detection}: FActScore, claim decomposition, verification
\item \textbf{Prevention}: Grounding, self-consistency, multi-agent review
\end{itemize}
\vspace{0.3cm}
\textbf{Next Week}
\begin{itemize}
