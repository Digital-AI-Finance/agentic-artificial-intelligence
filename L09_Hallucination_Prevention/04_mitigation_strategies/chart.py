...
plt.rcParams.update({
    ...
    'xtick.labelsize': 16, 'ytick.labelsize': 22, 'legend.fontsize': 16,
...
strategies = ['Baseline', 'RAG', 'Self-\nConsistency', 'Chain-of-\nVerification', 'Self-\nRefine', 'Multi-\nAgent']
...
ax1.annotate('Best\ntrade-off', xy=(3, 10), xytext=(4, 20),
            arrowprops=dict(arrowstyle='->', color=MLGREEN, lw=1.5),
            fontsize=12, color=MLGREEN, ha='center')
