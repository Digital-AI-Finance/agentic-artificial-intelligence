...
for i in range(100):
    ax.axvspan(0.5 + i*0.09, 0.5 + (i+1)*0.09, ymin=0.4, ymax=0.6,
               color=cmap(i/100), alpha=0.8)
...
# Arrow
ax.annotate('', xy=(9.3, 1.85), xytext=(0.7, 1.85),
            arrowprops=dict(arrowstyle='->', color=MLGRAY, lw=2))

ax.text(5, 3.5, 'Autonomy Spectrum', fontsize=24, fontweight='bold',
