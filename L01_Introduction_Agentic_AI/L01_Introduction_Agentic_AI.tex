...
\item \textbf{Understand}: Explain difference between LLM inference and agentic behavior
...
\begin{center}
\includegraphics[width=0.65\textwidth]{01_agent_definition/chart.pdf}
\end{center}
...
\begin{itemize}
\item \textbf{Reasoning}: Chain-of-Thought, Tree-of-Thoughts prompting
\item \textbf{Tool Use}: Function calling APIs (OpenAI, Anthropic, Google)
\item \textbf{Frameworks}: LangChain, LangGraph, AutoGen, CrewAI
\item \textbf{Context}: 100K+ token windows enable complex interactions
\end{itemize}
\vspace{0.3cm}
\textbf{Current State}
\begin{itemize}
...
\vspace{0.1cm}
\begin{center}
\includegraphics[width=0.50\textwidth]{02_react_paradigm/chart.pdf}
\end{center}
...
\item \textbf{Long-term}: Persistent storage (vector DB, knowledge graph)
\end{itemize}
...
\begin{itemize}
\item Function calling, MCP protocol
...
\item Reflexion, self-correction
\end{itemize}
...
\begin{itemize}
\item \textbf{Reliability}: Hallucinations, error propagation
\item \textbf{Planning}: Struggle with long-horizon tasks
\item \textbf{Evaluation}: Hard to measure agent quality
\item \textbf{Safety}: Unintended actions, jailbreaks
\end{itemize}
\vspace{0.3cm}
\textbf{Key Metric}
\begin{itemize}
\item AgentBench: GPT-4 achieves ~30\% on complex tasks
\end{itemize}
...
\textbf{Open Problems}
\begin{itemize}
\item \textbf{Scalable alignment}: How to align autonomous agents?
...
\item Constitutional AI for agent safety
\item World models for planning
\end{itemize}
...
\item Sumers et al. (2024). ``Language Agents: From Next-Token Prediction to Digital Automation.'' arXiv:2403.12897
\end{itemize}
