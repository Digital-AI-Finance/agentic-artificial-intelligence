...
# Performance line
line1 = ax1.plot(agents, task_performance, 'o-', linewidth=3, markersize=10,
                  color=MLGREEN, label='Task Performance')
...
ax2 = ax1.twinx()
line2 = ax2.plot(agents, coordination_cost, 's--', linewidth=3, markersize=10,
                  color=MLORANGE, label='Coordination Cost')
