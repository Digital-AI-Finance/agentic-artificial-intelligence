...
\begin{frame}[t]{AutoGen Conversation Pattern}
\begin{center}
\includegraphics[width=0.60\textwidth]{03_autogen_flow/autogen_flow.pdf}
\end{center}
\bottomnote{AutoGen enables multi-turn conversations with code execution capability.}
\end{frame}
...
\begin{frame}[t]{Coordination Overhead Analysis}
\begin{center}
\includegraphics[width=0.60\textwidth]{04_coordination_overhead/coordination_overhead.pdf}
\end{center}
\bottomnote{Optimal zone: 3-5 agents. Beyond that, coordination costs outweigh benefits.}
\end{frame}
