...
\begin{center}
\includegraphics[width=0.70\textwidth]{01_communication_topology/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.60\textwidth]{02_role_specialization/chart.pdf}
\end{center}
...
\item Human-in-the-loop integration
\end{itemize}
\vspace{0.3cm}
\textbf{Agent Types}
\begin{itemize}
...
\begin{itemize}
\item Standardized document formats (PRD, Design Doc)
...
\end{itemize}
\vspace{0.2cm}
\textbf{Mitigations}: Timeouts, circuit breakers, conflict resolution
