...
bars1 = ax.bar(x - width/2, swe_bench, width, label='SWE-bench', color=MLPURPLE, edgecolor='white', linewidth=1.5)
bars2 = ax.bar(x + width/2, swe_lite, width, label='SWE-bench Lite', color=MLORANGE, edgecolor='white', linewidth=1.5)
