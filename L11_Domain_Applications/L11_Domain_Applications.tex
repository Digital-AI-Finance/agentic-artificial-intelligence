...
\item Ridnik et al. (2024). ``AlphaCodium: Code Gen. with Flow Engineering (structured pipelines).'' arXiv:2401.08500
...
\item \textbf{Finance}: High value but requires compliance (regulatory) awareness
