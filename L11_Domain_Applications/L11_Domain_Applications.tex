...
\begin{itemize}
\item \textbf{Remember}: Define SWE-bench, code agent, FinAgent, clinical decision support
...
\end{itemize}
\vspace{0.3cm}
\textbf{Medium Maturity: Finance}
\begin{itemize}
\item Well-defined tasks (analysis, research, reporting)
\item Heavy regulatory constraints (compliance)
\item Emerging: Trading assistants, document analysis
\end{itemize}
\vspace{0.3cm}
\textbf{Emerging: Healthcare}
\begin{itemize}
\item High stakes, requires human oversight
\item Regulatory approval (FDA, HIPAA)
\item Focus: Decision support, not autonomous action
\end{itemize}
...
% ==================== SLIDE 11: Healthcare Agents ====================
\begin{frame}[t]{Healthcare Agents}
\textbf{Potential Applications}
\begin{itemize}
\item Clinical decision support (diagnosis assistance)
\item Drug interaction checking
\item Patient triage and routing
\item Medical literature synthesis
\end{itemize}
\vspace{0.3cm}
\textbf{Critical Constraints}
\begin{itemize}
\item \textbf{Regulation}: FDA approval for clinical use
\item \textbf{Privacy}: HIPAA compliance required
\item \textbf{Liability}: Who is responsible for errors?
\item \textbf{Verification}: Medical claims must be evidence-based
\end{itemize}
\vspace{0.3cm}
\textbf{Current Approach}
\begin{itemize}
\item Human-in-the-loop: Agents suggest, clinicians decide
\item Focus on augmentation, not automation
\end{itemize}
\bottomnote{Healthcare agents must support clinicians, not replace them.}
\end{frame}

% ==================== SLIDE 12: Healthcare Agents Chart ====================
...
% ==================== SLIDE 13: Cross-Domain Patterns ====================
...
\item \textbf{Finance}: Backtesting, compliance rules, risk limits
\item \textbf{Healthcare}: Evidence linking, confidence thresholds, human review
\end{itemize}
\vspace{0.3cm}
\textbf{Human-in-the-Loop Intensity}
\begin{itemize}
\item \textbf{Code}: Low (automated tests catch most errors)
\item \textbf{Finance}: Medium (compliance review for significant actions)
\item \textbf{Healthcare}: High (clinician approval for all recommendations)
\end{itemize}
\vspace{0.3cm}
...
\item Singhal et al. (2023). ``Large Language Models Encode Clinical Knowledge.'' Nature
\end{itemize}
\bottomnote{Focus on SWE-bench for understanding code agent evaluation.}
\end{frame}
...
\item \textbf{Healthcare}: Highest stakes; human oversight essential
\end{itemize}
\vspace{0.3cm}
