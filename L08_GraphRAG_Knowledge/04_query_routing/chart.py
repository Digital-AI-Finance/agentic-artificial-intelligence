...
bars1 = ax.bar(x - width, vector_rag, width, label='Vector RAG', color=MLPURPLE, edgecolor='white', linewidth=1.5)
bars2 = ax.bar(x, graph_rag, width, label='GraphRAG', color=MLORANGE, edgecolor='white', linewidth=1.5)
bars3 = ax.bar(x + width, hybrid, width, label='Hybrid', color=MLGREEN, edgecolor='white', linewidth=1.5)

ax.set_ylabel('Accuracy (%)', fontsize=22)
ax.set_title('Query Type Performance by RAG Approach', fontsize=24, fontweight='bold', color=MLPURPLE)
ax.set_xticks(x)
