...
\begin{itemize}
\item \textbf{Remember}: Define knowledge graphs, entities (objects), relations (links), communities (clusters)
...
\end{center}
\bottomnote{Leiden algorithm (graph clustering method) clusters entities for hierarchical summarization.}
\end{frame}
...
\item \textbf{Entity Extraction}: LLM-based NER (Named Entity Recognition) and relation extraction
