...
plt.tight_layout()
plt.savefig(Path(__file__).parent / "api_comparison.pdf", dpi=300, bbox_inches="tight", facecolor="white")
plt.close()
print(f"Chart saved to {Path(__file__).parent / 'api_comparison.pdf'}")
