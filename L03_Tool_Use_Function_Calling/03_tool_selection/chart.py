...
plt.rcParams.update({
    ...
    'xtick.labelsize': 20, 'ytick.labelsize': 22, 'legend.fontsize': 20,
...
bars1 = ax.bar(x - width, gpt4_acc, width, label='GPT-4', color=MLPURPLE, edgecolor='white', linewidth=1.5)
bars2 = ax.bar(x, gpt35_acc, width, label='GPT-3.5', color=MLBLUE, edgecolor='white', linewidth=1.5)
bars3 = ax.bar(x + width, opensource_acc, width, label='Open Source', color=MLORANGE, edgecolor='white', linewidth=1.5)
