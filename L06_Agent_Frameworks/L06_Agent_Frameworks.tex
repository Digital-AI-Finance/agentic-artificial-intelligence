...
\begin{itemize}
\item \textbf{Remember}: Define state machines, graphs, orchestration patterns
...
\begin{center}
\includegraphics[width=0.55\textwidth]{01_framework_comparison/chart.pdf}
\end{center}
...
\item Built-in checkpointing and persistence
...
\begin{center}
\includegraphics[width=0.60\textwidth]{02_langgraph_flow/chart.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.55\textwidth]{03_state_management/chart.pdf}
\end{center}
...
\textbf{Key Features}
\begin{itemize}
\item \textbf{Code Execution}: Docker/local code sandbox
...
\begin{center}
\includegraphics[width=0.60\textwidth]{04_orchestration_patterns/chart.pdf}
\end{center}
...
\textbf{Observability}
\begin{itemize}
\item LangSmith/LangFuse for tracing
