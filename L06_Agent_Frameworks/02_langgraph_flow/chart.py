...
ax.text(5, 5.7, 'LangGraph: Graph-Based Agent Flow', fontsize=24,
...
# State box
state_box = FancyBboxPatch((0.3, 0.2), 2.5, 1.0, boxstyle="round,pad=0.05",
                           facecolor='#F5F5F5', edgecolor=MLPURPLE, linewidth=2, linestyle='--')
