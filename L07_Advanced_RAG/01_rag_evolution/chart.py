...
ax.text(5, 5.7, 'Evolution of RAG Systems', fontsize=24,
...
stages = [
    ...
    (6.5, 'Self-RAG', '2024', MLORANGE, ['Self-reflection', 'Adaptive retrieval', 'Critique tokens']),
...
for x, name, year, color, features in stages:
    ...
    ax.text(x, 3.0, year[:2], fontsize=10, ha='center', va='center', color='white', fontweight='bold')
...
ax.annotate('', xy=(9.3, 3.0), xytext=(1.2, 3.0),
...
ax.text(5.25, 0.5, 'Capability & Complexity', fontsize=11, ha='center', color=MLGRAY, style='italic')
ax.annotate('', xy=(8.5, 0.8), xytext=(2.0, 0.8),
            arrowprops=dict(arrowstyle='->', color=MLGRAY, lw=1.5))
